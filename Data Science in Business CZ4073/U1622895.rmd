...
```{r}
lmFitY1_Attempt4 <- update(lmFitY1_Attempt3, ~ . - X3, data = trainData[,-15])
...
```{r}
lmFitY2_Attempt2 <- update(lmFitY2_Attempt1, ~ . - X2, data = trainData[,-14])
...
r2_rf_Y2 <- rSquared(testData[["Y2"]], testData[["Y2"]] - predict (randomForestY2, testData))
